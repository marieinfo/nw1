...
.logo{
  ...
  background-size: cover;
	...
	.img{
		height: 200px;
		width:200px;
		background-image:url("image/inf2.jpg");
		background-size:cover;
	}
	.blabla{
		position:absolute;
...
/*#4B908E*/
	...
	.img2{
		...
		margin-left:600px;
			...
			height: 200px;
		width:200px;
		background-image:url("image/docteur_bombe.jpg");
		background-size:cover;
	...
	.img3{
			...
			height: 200px;
		width:200px;
		background-image:url("image/docteur10.jpg");
		background-size:cover;
	}
	.blabla3{
				position:absolute;
	...
	.img4{
		...
		margin-left:600px;
			...
			height: 200px;
		width:200px;
		background-image:url("image/docteur9.jpg");
		background-size:cover;
	}
	.blabla4{
			position:absolute;
